/*
  ...
  $Header: //depot/swdev/LAN/Switch/KSZ/kernels/linux-3.18/drivers/scsi/osst.c#3 $
...
static const char * cvsid = "$Id: //depot/swdev/LAN/Switch/KSZ/kernels/linux-3.18/drivers/scsi/osst.c#3 $";
